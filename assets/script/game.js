cc.Class({
    ...
    gameOver () {
        ...
        console.log("Game over is here",this.node,"Component",this.node.getComponent('gameResult'),"Score",this.giftCollector.getScore());
        
        this.node.getComponent('gameResult').setNewScore(this.giftCollector.getScore());

        cc.director.loadScene('GameOver1',(data)=>{
            console.log("on Game over scene launched",data);
